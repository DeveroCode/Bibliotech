<div class="flex items-center justify-center p-12 w-full">
    <div class="mx-auto w-full max-w-[550px] bg-white">
      <form class="py-6 px-9" wire:submit.prevent='updatePie'>
        ...
        <div>
          <button class="hover:shadow-form w-full rounded-md bg-indigo-600 hover:bg-indigo-800 hover:transition-all hover:ease-linear hover:duration-200 py-3 px-8 text-center text-xl font-semibold text-white outline-none">
            Subir images
          </button>
        </div>
      </form>

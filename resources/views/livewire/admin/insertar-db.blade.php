            ...
            <div class="flex flex-col bg-white shadow-sm rounded p-4 h-auto">
                ...
                <div class="w-full mt-5">
                    <form action="{{ route('admin.update') }}" enctype="multipart/form-data"
                        ...
                        wire:submit.prevent='crearAlumnos'>

                        <!-- Botón de subir -->
                        <div class="w-full md:w-auto">
                            <button type="submit"
                                class="w-full md:w-auto flex items-center justify-center px-4 py-2 bg-indigo-700 text-white rounded-md cursor-pointer">
                                <svg class="w-6 h-6 md:w-8 md:h-8" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                    <path
                                        d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                                </svg>
                                <span class="ml-2 text-sm md:text-base uppercase font-bold">Upload</span>
                            </button>
                        </div>
                        ...
                        <div class="w-full md:w-auto">
                            ...
                            <label for="archivo-input"
                                class="w-full block text-center md:inline bg-indigo-700 text-white font-bold py-2 px-4 rounded cursor-pointer">
                                Seleccionar archivo
                            </label>
                        </div>
                    </form>

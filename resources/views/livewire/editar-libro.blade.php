<form class="md:w-1/2" wire:submit.prevent='editarLibro'>
    ...
    <div class="mt-5 flex">
        ...
        <div class="w-1/2">
            <x-input-label for="categoria" :value="__('categoría')" class="uppercase" />

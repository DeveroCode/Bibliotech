            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="w-full md:w-1/4 bg-white rounded-lg border border-gray-200 shadow-md mb-6 md:mr-6 md:mb-0">
                    <div class="flex flex-col items-center pb-10">
                        ...
                        <a type="submit" href="{{ route('inventory.printInventory') }}"
                            class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white mt-4 lg:mt-6 bg-indigo-500 rounded-lg hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 uppercase">Imprimir PDF</a>
                    </div>
                </div>
                {{-- Loans --}}
                <div class="w-full md:w-1/4 bg-white rounded-lg border border-gray-200 shadow-md mb-6 md:mr-6 md:mb-0">

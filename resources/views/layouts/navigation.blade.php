                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                {{-- <x-dropdown-link :href="route('dashboard.regisAlum')"
                                    :active="request()->routeIs('dashboard.regisAlum')">
                                    {{ __('Admin Entradas') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('dashboard.showAdma')"
                                    :active="request()->routeIs('dashboard.showAdma')">
                                    {{ __('Registro Entradas') }}
                                </x-dropdown-link> --}}

                                <x-dropdown-link :href="route('dashboard.regist')"
                                    :active="request()->routeIs('dashboard.regist')">
                                    {{ __('Administrar Entradas Libros') }}
                                </x-dropdown-link>
...
{{--Enlaces Meli y Mari--}}
        ...
        <div x-data="{ open: false }" class="sm:hidden">
            ...
            <div x-show="open" @click.away="open = false">
                {{-- boton de acceder a los administrativos --}}
                {{-- <x-responsive-nav-link :href="route('dashboard.regisAlum')" :active="request()->routeIs('dashboard.regisAlum')">
                {{ __('Administrar Entradas') }}
                </x-responsive-nav-link>
                {{-- boton de acceder a registro de usuario --}}
                {{-- <x-responsive-nav-link :href="route('dashboard.showAdma')" :active="request()->routeIs('dashboard.showAdma')">
                    {{ __('Registro Entradas') }}
                </x-responsive-nav-link>  --}}
                {{-- boton de acceder a administrar entradas libros --}}
                <x-responsive-nav-link :href="route('dashboard.regist')" :active="request()->routeIs('dashboard.regist')">
                    {{ __('Administrar Entradas Libros') }}
                </x-responsive-nav-link>
            </div>
        </div>

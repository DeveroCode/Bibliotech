                        ...
                        <td class="group-tbody-categoria">
                            <div class="group-categoria">
                                @switch($libro->categoria->id)
                                    @case(1)
                                        <span
                                            class="group-all sistemas">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(2)
                                        <span
                                        class="group-all contaduria">
                                        {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(3)
                                        <span
                                            class="group-all mecatronica">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(4)
                                        <span
                                            class="group-all electromecanica">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(5)
                                        <span
                                            class="group-all gestion">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(6)
                                        <span
                                            class="group-all industrial">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @case(7)
                                        <span
                                            class="group-all electronica">
                                            {{ $libro->categoria->categoria}}
                                        </span>
                                        @break
                                    @default
